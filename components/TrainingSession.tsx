                                    ...
                                    {!isUnavailable && cycleTrainings.length > 0 && (
                                        <div className="space-y-2">
                                            {cycleTrainings.map((training) => {
                                                ...
                                                const euVotei = (availabilities[training.id] || []).some(a => a.user_id === user?.id);

                                                return (
                                                    <div key={training.id} className={`border rounded-lg overflow-hidden ${euVotei ? 'bg-green-50 border-green-300' : 'bg-white'}`}>                                                        <div
